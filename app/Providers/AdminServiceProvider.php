<?php
    ...
    class AdminServiceProvider extends ServiceProvider
    {
        ...
        {
            if (config('administrator.translations.enabled') and auth()->user()->is_super_admin) {
                $tools->url(
         ...
         * @return $this
         */
        protected function withLogsReader(MenuBuilder $tools): self
        {
            if (config('administrator.logs.enabled')) {
                $tools->url(
                    route('scaffold.logs_reader.index'),
                    trans('administrator::module.resources.logs_reader'),
                    4,
